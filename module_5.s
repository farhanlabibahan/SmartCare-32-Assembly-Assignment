...
; DATA SECTION
; =========================================================
        AREA    TreatmentData, DATA, READWRITE
        ALIGN   4

; ---------------------------------------------------------
; LOOKUP TABLE (100 entries, for codes 0–99)
;   cost(code n) = (n+1)*100 as an example
; ---------------------------------------------------------
TREATMENT_TABLE
...
TREATMENT_CODE    DCD     11      ; example input value (valid: 0–99)
